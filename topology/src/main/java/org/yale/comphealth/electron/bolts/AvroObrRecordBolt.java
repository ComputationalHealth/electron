...
public class AvroObrRecordBolt extends AbstractHdfsBolt {

    private static final Logger LOG = LoggerFactory.getLogger(AvroObrRecordBolt.class);

    private transient FSDataOutputStream out;
    private Schema schema;
    private DataFileWriter<ObrAvroModel> avroWriter;
    private boolean enableSnappyCompression = false;

    public AvroObrRecordBolt withFsUrl(String fsUrl){
        this.fsUrl = fsUrl;
        return this;
    }

    public AvroObrRecordBolt withConfigKey(String configKey){
        this.configKey = configKey;
        return this;
    }

    public AvroObrRecordBolt withFileNameFormat(FileNameFormat fileNameFormat){
        this.fileNameFormat = fileNameFormat;
        return this;
    }

    public AvroObrRecordBolt withSyncPolicy(SyncPolicy syncPolicy){
        this.syncPolicy = syncPolicy;
        return this;
    }

    public AvroObrRecordBolt withRotationPolicy(FileRotationPolicy rotationPolicy){
        this.rotationPolicy = rotationPolicy;
        return this;
    }

    public AvroObrRecordBolt withSnappyCompression(boolean isEnabled){
        this.enableSnappyCompression = isEnabled;
        return this;
    }

    public AvroObrRecordBolt addRotationAction(RotationAction action){
        this.rotationActions.add(action);
        return this;
    }

    public AvroObrRecordBolt withTickTupleIntervalSeconds(int interval) {
    ...
    void doPrepare(Map conf, TopologyContext topologyContext, OutputCollector collector) throws IOException {
        ...
        this.schema = ObrAvroModel.SCHEMA$;
    }

    @Override
    void writeTuple(Tuple tuple) throws IOException {
        ObrAvroModel avroRecord = (ObrAvroModel) tuple.getValue(0);
    ...
    Path createOutputFile() throws IOException {
        ...
        //Initialize writer
        DatumWriter<ObrAvroModel> datumWriter = new GenericDatumWriter<>(ObrAvroModel.SCHEMA$);
